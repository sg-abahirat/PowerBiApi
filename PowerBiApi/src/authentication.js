...
const getAccessToken = async function () {
    ...
    if (config.authenticationMode.toLowerCase() === "masteruser") {
        ...
        return new Promise(
            (resolve, reject) => {
                context.acquireTokenWithUsernamePassword(config.scope, config.pbiUsername,config.pbiPassword,config.clientId,config.clientSecret ,function (err, tokenResponse) {
